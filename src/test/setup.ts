...
vi.mock('react-i18next', () => {
  const translations = {
    ...
    'settings.terminology.cleanNote': "Currently on defaults — applying the preset will fill in suggested names for {{label}}. Nothing will be overwritten that you'd miss.",
    ...
    'settings.terminology.overwriteCount': "{{count}} customized name will be replaced. You'll still be able to adjust any field after applying.",
    'settings.terminology.overwriteCount_other': "{{count}} customized names will be replaced. You'll still be able to adjust any field after applying.",
