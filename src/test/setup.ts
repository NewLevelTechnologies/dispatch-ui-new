...
vi.mock('react-i18next', () => {
  const translations = {
    ...
    'common.actions.couldNotLoad': "Couldn't load {{entities, lowercase}}",
    ...
    'common.actions.noMatchFilters': 'No {{entities, lowercase}} match your filters',
    ...
    'equipment.search.placeholder': 'Search by serial number, model, or location…',
    ...
    'payments.search.placeholder': 'Search by reference, customer, or invoice #…',
    ...
    'settings.equipmentTaxonomy.addCategoryTo': 'Add category to {{name}}',
    'settings.equipmentTaxonomy.addType': 'Add type',
    'settings.equipmentTaxonomy.clearSearch': 'Clear search',
    'settings.equipmentTaxonomy.collapseAll': 'Collapse all',
    'settings.equipmentTaxonomy.delete.categoryMessage': '{{entity}} records using this category will lose their category assignment.',
    'settings.equipmentTaxonomy.delete.categoryTitle': 'Delete {{name}}?',
    'settings.equipmentTaxonomy.delete.typeMessage': '{{count}} categories will be deleted. {{entity}} records using this type will lose their type assignment.',
    'settings.equipmentTaxonomy.delete.typeMessageEmpty': 'This type has no categories. Delete?',
    'settings.equipmentTaxonomy.delete.typeMessageOne': '1 category will be deleted. {{entity}} records using this type will lose their type assignment.',
    'settings.equipmentTaxonomy.delete.typeTitle': 'Delete {{name}}?',
    'settings.equipmentTaxonomy.dialog.addCategoryTo': 'Add category to {{name}}',
    'settings.equipmentTaxonomy.dialog.addType': 'Add {{entity, lowercase}} type',
    'settings.equipmentTaxonomy.dialog.editCategory': 'Edit category',
    'settings.equipmentTaxonomy.dialog.editType': 'Edit {{entity, lowercase}} type',
    'settings.equipmentTaxonomy.empty.noCategoriesTitle': 'No categories yet',
    'settings.equipmentTaxonomy.empty.noMatchDescription': 'Try a different search term.',
    'settings.equipmentTaxonomy.empty.noMatchTitle': 'No types or categories match your search',
    'settings.equipmentTaxonomy.empty.noTypesDescription': 'Add your first type — categories nest within types.',
    'settings.equipmentTaxonomy.empty.noTypesTitle': 'No {{entity, lowercase}} types yet',
    'settings.equipmentTaxonomy.errorLoad': "Couldn't load {{entity, lowercase}} types",
    'settings.equipmentTaxonomy.errorSaveCategory': 'Failed to save category',
    'settings.equipmentTaxonomy.errorSaveType': 'Failed to save {{entity, lowercase}} type',
    'settings.equipmentTaxonomy.expandAll': 'Expand all',
    'settings.equipmentTaxonomy.loading': 'Loading {{entity, lowercase}} types…',
    'settings.equipmentTaxonomy.searchPlaceholder': 'Search types & categories…',
    'settings.equipmentTaxonomy.subtitle': '{{entity}} classifications used when adding {{entity, lowercase}} records. Drag to reorder — order shown is the order in dropdowns.',
    'settings.equipmentTaxonomy.title': 'Types & Categories',
    'settings.equipmentTaxonomy.toast.categoryDeleted': 'Category deleted',
    'settings.equipmentTaxonomy.toast.deleteCategoryFailed': "Couldn't delete category",
    'settings.equipmentTaxonomy.toast.deleteTypeFailed': "Couldn't delete type",
    'settings.equipmentTaxonomy.toast.reorderCategoriesFailed': "Couldn't reorder categories",
    'settings.equipmentTaxonomy.toast.reorderTypesFailed': "Couldn't reorder types",
    'settings.equipmentTaxonomy.toast.typeDeleted': 'Type deleted',
    ...
    'settings.equipmentTypes.table.categories': 'Categories',
    'settings.equipmentTypes.table.items': 'Items',
    ...
    'settings.filterSizes.emptyDescription':
      'Add a size or seed the common HVAC defaults to get started.',
    'settings.filterSizes.emptyTitle': 'No filter sizes yet',
    ...
    'settings.filterSizes.noMatchTitle': 'No sizes match your search',
    'settings.filterSizes.searchPlaceholder': 'Search sizes…',
    'settings.filterSizes.seedCommon': 'Seed common sizes',
    'settings.filterSizes.seedCommonConfirmBody':
      'Adds the standard 10 HVAC residential filter sizes to your list. Existing sizes are not affected — duplicates are skipped.',
    'settings.filterSizes.seedCommonConfirmTitle': 'Add common filter sizes?',
    'settings.filterSizes.seedCommonCta': 'Seed common sizes',
    'settings.filterSizes.seedCommonHelp':
      'Add the 10 most-common HVAC residential filter sizes. Skips any already in your list.',
    'settings.filterSizes.seedResult': 'Added {{added}}, skipped {{skipped}}.',
    'settings.filterSizes.seedSkipped': 'All common sizes are already in your list.',
    'settings.filterSizes.seedSuccess': '{{count}} sizes added',
    'settings.filterSizes.size': 'Size',
    'settings.filterSizes.subtitle': '{{count}} filter sizes · quick-add chips on equipment forms',
    'settings.filterSizes.thickness': 'Thickness (in)',
    'settings.filterSizes.title': 'Filter Sizes',
    'settings.filterSizes.titleAdd': 'Add Filter Size',
    'settings.filterSizes.titleEdit': 'Edit Filter Size',
    'settings.filterSizes.toastDeleteFailed': "Couldn't delete size",
    'settings.filterSizes.toastDeleted': 'Size deleted',
    'settings.filterSizes.toastReorderFailed': "Couldn't reorder sizes",
    'settings.filterSizes.toastSeedFailed': "Couldn't seed common sizes",
    'settings.filterSizes.width': 'Width (in)',
    'settings.dispatchRegions.clearSearch': 'Clear search',
    'settings.dispatchRegions.col.abbreviation': 'Abbreviation',
    'settings.dispatchRegions.col.name': 'Name',
    'settings.dispatchRegions.col.status': 'Status',
    'settings.dispatchRegions.disableConfirm.body':
      'Service locations and technicians assigned to "{{name}}" will lose their region. They\'ll appear in an Unassigned bucket on the {{dispatch, lowercase}} board until reassigned.',
    'settings.dispatchRegions.disableConfirm.title': 'Disable "{{name}}"?',
    'settings.dispatchRegions.emptyDescription':
      'Add a region to start organizing service locations and technicians on the {{dispatch, lowercase}} board.',
    'settings.dispatchRegions.emptyTitle': 'No {{regions, lowercase}} yet',
    'settings.dispatchRegions.field.abbreviation': 'Abbreviation',
    'settings.dispatchRegions.field.abbreviationHint': 'Short code on board cells, e.g. GA, ATL',
    'settings.dispatchRegions.field.name': 'Name',
    'settings.dispatchRegions.loading': 'Loading {{regions, lowercase}}…',
    'settings.dispatchRegions.searchPlaceholder': 'Search {{regions, lowercase}}…',
    'settings.dispatchRegions.subtitle': '{{count}} {{regions, lowercase}}',
    'settings.dispatchRegions.titleAdd': 'Add {{region}}',
    'settings.dispatchRegions.titleEdit': 'Edit {{region}}',
    'settings.dispatchRegions.toast.disabled': 'Region disabled',
    'settings.dispatchRegions.toast.disableFailed': "Couldn't disable region",
    'settings.dispatchRegions.toast.enabled': 'Region enabled',
    'settings.dispatchRegions.toast.enableFailed': "Couldn't enable region",
    'settings.dispatchRegions.toast.reorderFailed': "Couldn't reorder regions",
    ...
    'serviceLocations.search.placeholder': 'Search by name or address…',
    ...
    'users.empty.noUsersDescription': 'Invite your team to get started.',
    ...
    'users.breakdown.invited': '{{count}} invited',
    'users.filter.all': 'All',
    'users.filter.allInvitationStatuses': 'Any invitation',
    ...
    'users.filter.invitationActive': 'Active',
    'users.filter.invitationExpired': 'Invitation expired',
    'users.filter.invitationInvited': 'Invited',
    'users.filter.invitationStatus': 'Invitation',
    ...
    'roles.actions.duplicate': 'Duplicate',
    ...
    'roles.description': 'Bundles of capabilities you assign to users. A user can have multiple roles — capabilities combine. Built-in roles can be edited but not deleted.',
    ...
    'roles.sort.label': 'Sort by',
    'roles.sort.users': 'Users (desc)',
    'roles.summary.builtIn': 'Built-in',
    'roles.summary.custom': 'Custom',
    'roles.summary.roles': 'Roles',
    'roles.summary.totalCapabilities': 'Total capabilities',
    'roles.summary.usersAssigned': 'Users assigned',
    'roles.filter.all': 'All',
    'roles.filter.any': 'Any',
    'roles.filter.builtIn': 'Built-in',
    'roles.filter.clearFilters': 'Clear filters',
    'roles.filter.custom': 'Custom',
    'roles.filter.hasUsers': 'Has users',
    'roles.filter.no': 'No',
    'roles.filter.type': 'Type',
    'roles.filter.yes': 'Yes',
    'roles.detail.allRoles': 'All roles',
    'roles.detail.backToRoles': '← All roles',
    'roles.detail.builtInLockTitle': 'Built-in role',
    'roles.detail.capabilitiesGrouped': 'Grouped by management area. Capabilities a user can perform when assigned this role.',
    'roles.detail.capabilitiesNoneInArea': 'No capabilities in this area',
    'roles.detail.capCount': '{{granted}} of {{total}} capabilities ({{pct}}%)',
    'roles.detail.created': 'Created',
    'roles.detail.deleteBlocked': '{{count}} users still hold this role. Deletion is blocked until the role has zero members.',
    'roles.detail.deleteEmpty': 'No users hold this role. Deleting is permanent and removes the role from the access model.',
    'roles.detail.deleteRole': 'Delete role',
    'roles.detail.description': 'Description',
    'roles.detail.editCapabilities': 'Edit capabilities',
    'roles.detail.fullLabel': 'Full',
    'roles.detail.lastUpdated': 'Last Updated',
    'roles.detail.membersDescription': 'Users who have this role. They may have other roles too.',
    'roles.detail.membersEmpty': 'No users have this role yet.',
    'roles.detail.membersHeader': 'Members',
    'roles.detail.noneLabel': 'None',
    'roles.detail.openInUsers': 'Open in Users →',
    'roles.detail.partialLabel': 'Partial',
    'roles.detail.reassignFirst': 'Reassign first →',
    'roles.detail.remove': 'Remove',
    'roles.detail.roleId': 'Role ID',
    'roles.detail.roleInfo': 'Role Information',
    'roles.detail.showAll': 'Show all',
    'roles.detail.showAllMembers': 'Show all {{count}} members ↓',
    'roles.detail.showFewer': 'Show fewer',
    'roles.detail.showGrantedOnly': 'Granted only',
    ...
    'roles.detail.usersAssigned': '{{count}} users assigned',
    'roles.detail.view': 'View',
    'roles.form.addTitle': 'Add role',
    'roles.form.adminLockBody': 'Admin is the platform-defined full-access role. Capabilities can\'t be customized.',
    'roles.form.adminLockTitle': 'Admin role',
    'roles.form.allRoles': 'All {{entities}}',
    'roles.form.blank': 'Blank',
    'roles.form.capabilitiesHiddenByFilter': '{{count}} capabilities hidden by filter',
    'roles.form.capabilityFilterPlaceholder': 'Filter capabilities…',
    'roles.form.capabilityHelpLink': 'What\'s the difference between View / Edit / All? →',
    'roles.form.capabilitySubtitle': 'Check the actions users with this role can perform.',
    'roles.form.capCountSummary': '{{count}} of {{total}} capabilities · across {{areas}} areas',
    'roles.form.changesTakeEffect': 'Changes take effect on next sign-in',
    'roles.form.clearAll': 'Clear all',
    'roles.form.clearArea': 'Clear area',
    'roles.form.clearFilter': 'Clear filter',
    'roles.form.colorConflict': 'This color is now used by {{name}}. Pick another.',
    'roles.form.colorLabel': 'Color',
    'roles.form.colorTakenBy': 'Used by {{name}}',
    ...
    'roles.form.descriptionHint': 'shown on the roles list and inline help',
    'roles.form.descriptionLabel': 'Description',
    'roles.form.descriptionPlaceholder': 'One line describing what this role is for.',
    'roles.form.editTitle': 'Edit {{name}}',
    'roles.form.errorEmptyCapabilities': 'Pick at least one capability. A role with zero capabilities can\'t grant access.',
    'roles.form.namePlaceholder': 'e.g. Refund Approver',
    'roles.form.removalWarningArea': '{{area}}: removing {{count}} capabilities',
    'roles.form.removalWarningTitle': '{{count}} users hold this role.',
    'roles.form.save': 'Save changes',
    'roles.form.selectAll': 'Select all',
    'roles.form.startFromSubtitle': 'Optional. Copy capabilities from an existing role, then refine below.',
    'roles.form.startFromTitle': 'Start from',
    'roles.form.subtitleAdd': 'Bundle a set of capabilities under a name. Users can be assigned this role like any built-in role.',
    'roles.form.subtitleEdit': 'Edit name, description, color, and capabilities. Built-in roles can be modified but not deleted.',
    'roles.form.title': 'Role name',
    'roles.breakdown.builtIn': '{{count}} built-in',
    'roles.breakdown.custom': '{{count}} custom',
    'roles.table.builtIn': 'Built-in',
    'roles.table.capabilities': 'Capabilities',
    'roles.table.custom': 'Custom',
    'roles.table.description': 'Description',
    'roles.table.lastModified': 'Last modified',
    'roles.table.lastUpdated': 'Last Updated',
    'roles.table.role': 'Role',
    'roles.table.type': 'Type',
    'public.cliff.contact':
      'Please contact the company that sent this to you for an updated link.',
    'public.cliff.error':
      "We couldn't load this right now. Please try the link again, or contact the company that sent it to you.",
    'public.cliff.headline': 'This link is no longer available',
    'public.cliff.invalid':
    ...
    'public.invoice.billedTo': 'Billed to',
    'public.invoice.contactCta': 'Contact {{tenant}}',
    'public.invoice.dueOn': 'Due {{date}}',
    'public.invoice.invoiceDate': 'Invoice date',
    'public.invoice.items': 'Items',
    'public.invoice.label': 'Invoice',
    'public.invoice.loading': 'Loading invoice…',
    'public.invoice.notes': 'Notes',
    'public.invoice.paid': 'Paid',
    'public.invoice.paymentMethod.ACH': 'ACH transfer',
    'public.invoice.paymentMethod.CASH': 'Cash',
    'public.invoice.paymentMethod.CHECK': 'Check',
    'public.invoice.paymentMethod.CREDIT_CARD': 'Credit card',
    'public.invoice.paymentMethod.DEBIT_CARD': 'Debit card',
    'public.invoice.paymentMethod.OTHER': 'Other',
    'public.invoice.paymentMethod.WIRE_TRANSFER': 'Wire transfer',
    'public.invoice.paymentVoided': 'Voided',
    'public.invoice.paymentsReceived': 'Payments received',
    'public.invoice.questions': 'Questions about this invoice?',
    'public.invoice.status.cancelled': 'Cancelled',
    'public.invoice.status.draft': 'Draft',
    'public.invoice.status.outstanding': 'Outstanding',
    'public.invoice.status.paid': 'Paid',
    'public.invoice.status.partiallyPaid': 'Partially paid',
    'public.invoice.status.pastDue': 'Past due',
    'public.invoice.subtotal': 'Subtotal',
    'public.invoice.tax': 'Tax',
    'public.invoice.taxWithRate': 'Tax ({{rate}}%)',
    'public.invoice.total': 'Total',
    'public.invoice.voidedHeadline': 'This invoice has been voided',
    'public.invoice.voidedSubline':
      'Please contact {{tenant}} for the current invoice.',
    'public.quote.contactCta': 'Contact {{tenant}}',
    'public.quote.expiredOn': 'Expired {{date}}',
    'public.quote.items': 'Items',
    'public.quote.label': 'Quote',
    'public.quote.loading': 'Loading quote…',
    'public.quote.notes': 'Notes',
    'public.quote.questions': 'Questions about this quote?',
    'public.quote.quoteDate': 'Quote date',
    'public.quote.quotedTo': 'Quoted to',
    'public.quote.status.accepted': 'Accepted',
    'public.quote.status.cancelled': 'Cancelled',
    'public.quote.status.declined': 'Declined',
    'public.quote.status.draft': 'Draft',
    'public.quote.status.expired': 'Expired',
    'public.quote.status.pending': 'Pending',
    'public.quote.subtotal': 'Subtotal',
    'public.quote.tax': 'Tax',
    'public.quote.taxWithRate': 'Tax ({{rate}}%)',
    'public.quote.total': 'Total',
    'public.quote.validThrough': 'Valid through {{date}}',
    ...
    'workOrders.filters.archived': 'Archived',
    'workOrders.filters.archivedHidden': 'hidden',
    'workOrders.filters.archivedOnly': 'only',
    'workOrders.filters.archivedShown': 'shown',
    ...
    'workOrders.filters.searchPlaceholder': 'Search by WO#, customer, or address…',
    ...
    'workOrders.progress.awaitingSchedule': 'Awaiting Schedule',
    ...
    'workOrders.dispatches.completedAt': 'Completed {{time}}',
    'workOrders.dispatches.deleteConfirm': 'Delete this dispatch? The technician assignment will be removed.',
    'workOrders.dispatches.deleteError': 'Failed to delete dispatch',
    'workOrders.dispatches.drawer.contact': 'Contact',
    'workOrders.dispatches.drawer.copied': 'Copied',
    'workOrders.dispatches.drawer.copyPhone': 'Click to copy',
    'workOrders.dispatches.drawer.lifecycle': 'Lifecycle',
    'workOrders.dispatches.drawer.lifecycleArrived': 'Arrived',
    'workOrders.dispatches.drawer.lifecycleCreated': 'Created',
    'workOrders.dispatches.drawer.lifecycleDeparted': 'Departed',
    'workOrders.dispatches.drawer.lifecycleWindow': 'Arrival window',
    'workOrders.dispatches.drawer.notes': 'Notes',
    'workOrders.dispatches.drawer.notifications': 'Notification history',
    ...
    'workOrders.dispatches.onSitePast': 'On site {{start}}–{{end}} ({{duration}})',
    'workOrders.dispatches.onSiteSince': 'On site since {{time}}',
    'workOrders.dispatches.overdue': 'Overdue',
    'workOrders.dispatches.past': 'Past ({{count}})',
    ...
    'settings.divisions.codeChangedWarning': 'Changing the code may break integrations and reports that reference this division.',
    'settings.divisions.codeHint': 'Stable identifier. UPPERCASE_WITH_UNDERSCORES. Auto-generated from name.',
    'settings.divisions.codeImmutable': 'Editing the code may break integrations and reports.',
    'settings.divisions.colCode': 'Code',
    'settings.divisions.colName': 'Name',
    'settings.divisions.couldNotLoad': "Couldn't load divisions",
    'settings.divisions.deleteConfirm': 'Delete "{{name}}"?',
    'settings.divisions.deleteWarning': 'Customers, technicians, and work orders assigned to this division will become unassigned.',
    'settings.divisions.description': 'Operating units used to organize {{divisions}} and route work.',
    'settings.divisions.emptyDescription': 'Add a division to split your dispatch board view by team, region, or service line.',
    'settings.divisions.emptyTitle': 'No divisions yet',
    'settings.divisions.errorCreate': 'Failed to create division',
    'settings.divisions.errorUpdate': 'Failed to update division',
    'settings.divisions.form.create': 'Create division',
    'settings.divisions.form.save': 'Save changes',
    'settings.divisions.form.titleAdd': 'Add Division',
    'settings.divisions.form.titleEdit': 'Edit {{name}}',
    'settings.divisions.noMatches': 'No divisions match your search.',
    'settings.divisions.rowsCount': '{{count}} {{noun}}',
    'settings.divisions.searchPlaceholder': 'Search divisions…',
    'settings.divisions.subtitle': '{{count}} divisions · split the dispatch board view and segment reports',
    'settings.itemStatuses.builtInBadge': 'Built-in',
    'settings.itemStatuses.builtInCantDelete': "Built-in statuses can't be deleted.",
    'settings.itemStatuses.categoryChangedWarning': "Changing a built-in status's category may affect dispatch queue and progress rollups.",
    'settings.itemStatuses.categoryHelper': 'Groups statuses for the dispatch queue and progress rollups.',
    'settings.itemStatuses.codeHint': 'Stable identifier. UPPERCASE_WITH_UNDERSCORES. Auto-generated from name.',
    'settings.itemStatuses.codeImmutable': 'Code cannot be changed after creation.',
    'settings.itemStatuses.codeLockedHint': 'Built-in status codes are stable identifiers used by reports and integrations. Rename it freely — the code stays.',
    'settings.itemStatuses.colCategory': 'Category',
    'settings.itemStatuses.colCode': 'Code',
    'settings.itemStatuses.colName': 'Name',
    'settings.itemStatuses.colorHint': 'Shown on work item lists, the dispatch board, and reports.',
    'settings.itemStatuses.colorLabel': 'Color',
    'settings.itemStatuses.couldNotLoad': "Couldn't load {{workItem, lowercase}} statuses",
    'settings.itemStatuses.deleteConfirm': 'Delete "{{name}}"?',
    'settings.itemStatuses.deleteWarning': '{{workItem}}s currently in this status will keep their value, but the status will no longer appear in pickers or workflow transitions.',
    'settings.itemStatuses.description': 'Customize the lifecycle statuses that {{workItem, lowercase}}s move through.',
    'settings.itemStatuses.emptyDescription': 'Add a status to start tracking {{workItem, lowercase}} progress.',
    'settings.itemStatuses.emptyTitle': 'No {{workItem, lowercase}} statuses yet',
    'settings.itemStatuses.errorCreate': 'Failed to create status',
    'settings.itemStatuses.errorDelete': 'Failed to delete status',
    'settings.itemStatuses.errorReorder': 'Failed to reorder status',
    'settings.itemStatuses.errorUpdate': 'Failed to update status',
    'settings.itemStatuses.form.create': 'Create status',
    'settings.itemStatuses.form.save': 'Save changes',
    'settings.itemStatuses.form.titleAdd': 'Add {{workItem}} Status',
    'settings.itemStatuses.form.titleEdit': 'Edit {{name}}',
    'settings.itemStatuses.isTerminalHelper': '{{workItem}}s in a terminal status are considered done — they no longer transition forward.',
    'settings.itemStatuses.noMatches': 'No statuses match your search.',
    'settings.itemStatuses.rowsCount': '{{count}} {{noun}}',
    'settings.itemStatuses.searchPlaceholder': 'Search statuses…',
    'settings.itemStatuses.singular': 'Status',
    'settings.itemStatuses.statusSingular': 'Status',
    'settings.itemStatuses.subtitle': '{{count}} statuses · used to track {{workItem, lowercase}} progress through dispatch and completion',
    'settings.itemStatuses.table.category': 'Category',
    'settings.itemStatuses.table.terminal': 'Terminal',
    'settings.itemStatuses.terminalBadge': 'Terminal',
    'settings.itemStatuses.title': '{{workItem}} Statuses',
    'settings.businessDefaults.description': 'How operations and money behave by default. Used when nothing more specific is set on a record.',
    'settings.businessDefaults.financial': 'Financial',
    'settings.businessDefaults.operational': 'Operational',
    'settings.businessDefaults.taxRateHelper': 'e.g. 0.0825 = 8.25%',
    'settings.businessDefaults.termsHelper': 'Pre-filled on new invoices; individual invoices can override.',
    'settings.businessDefaults.terms.dueOnReceipt': 'Due on receipt',
    'settings.businessDefaults.terms.net15': 'Net 15',
    'settings.businessDefaults.terms.net30': 'Net 30',
    'settings.businessDefaults.terms.net45': 'Net 45',
    'settings.businessDefaults.terms.net60': 'Net 60',
    'settings.businessDefaults.timezoneHelper': 'Used for scheduling, dispatch windows, and timestamps on customer-facing documents.',
    'settings.businessDefaults.title': 'Business Defaults',
    'settings.companyProfile.description': 'Your business identity. Name and address appear on customer-facing documents.',
    'settings.companyProfile.logo': 'Logo',
    'settings.companyProfile.logoHelperLong': 'PNG, JPG, or SVG · max 5 MB · square images render best (transparent background recommended)',
    'settings.companyProfile.logoNone': 'No logo',
    'settings.companyProfile.logoReplace': 'Replace',
    'settings.companyProfile.logoRemove': 'Remove',
    'settings.companyProfile.logoSection': 'Appears in the app header and email templates',
    'settings.companyProfile.logoUploaded': 'Logo uploaded',
    'settings.companyProfile.logoUploadedAt': 'uploaded {{date}}',
    'settings.companyProfile.shortNameHint': 'appears in nav',
    'settings.companyProfile.title': 'Company Profile',
    'settings.modulesFeatures.communications': 'Communications',
    'settings.modulesFeatures.description': 'Turn product capabilities on or off for your organization. Some modules are still in development.',
    'settings.modulesFeatures.selfService': 'Self-service',
    'settings.modulesFeatures.title': 'Modules & Features',
    'settings.modulesFeatures.workflow': 'Workflow',
    'settings.modulesFeatures.feature.approvals': 'Approvals',
    'settings.modulesFeatures.feature.approvalsDesc': 'Require manager sign-off on quotes above a threshold.',
    'settings.modulesFeatures.feature.customerPortal': 'Customer Portal',
    'settings.modulesFeatures.feature.customerPortalDesc': 'Let customers view invoices, quotes, and upcoming visits.',
    'settings.modulesFeatures.feature.email': 'Email Notifications',
    'settings.modulesFeatures.feature.emailDesc': 'Send automated emails (work order confirmations, dispatch updates, receipts).',
    'settings.modulesFeatures.feature.jobCosting': 'Job Costing',
    'settings.modulesFeatures.feature.jobCostingDesc': 'Track labor and parts cost against revenue per work order.',
    'settings.modulesFeatures.feature.onlineBooking': 'Online Booking',
    'settings.modulesFeatures.feature.onlineBookingDesc': 'Customers can request a visit from a public booking page.',
    'settings.modulesFeatures.feature.sms': 'SMS Notifications',
    'settings.modulesFeatures.feature.smsDesc': 'Send text reminders and en-route messages from the tenant phone number.',
    'settings.nav.businessDefaults': 'Business Defaults',
    'settings.nav.companyProfile': 'Company Profile',
    'settings.notificationTemplates.action.customize': 'Customize',
    'settings.notificationTemplates.action.edit': 'Edit',
    'settings.notificationTemplates.audience.customer': 'Customer',
    'settings.notificationTemplates.audience.internal': 'Internal',
    'settings.notificationTemplates.channel.email': 'Email',
    'settings.notificationTemplates.channel.sms': 'SMS',
    'settings.notificationTemplates.clearFilters': 'Clear filters',
    'settings.notificationTemplates.description': 'Customize email and SMS notification templates for your organization.',
    'settings.notificationTemplates.empty': 'No notification templates found.',
    'settings.notificationTemplates.emptyDescription': 'Templates are seeded automatically.',
    'settings.notificationTemplates.errorLoad': 'Failed to load notification templates.',
    'settings.notificationTemplates.errorLoadDetail': 'Failed to load template details',
    'settings.notificationTemplates.errorRevert': 'Failed to revert template to default',
    'settings.notificationTemplates.filter.allAudiences': 'All audiences',
    'settings.notificationTemplates.filter.allChannels': 'All channels',
    'settings.notificationTemplates.filter.allStatuses': 'All statuses',
    'settings.notificationTemplates.filter.audience': 'Audience',
    'settings.notificationTemplates.filter.channel': 'Channel',
    'settings.notificationTemplates.filter.status': 'Status',
    'settings.notificationTemplates.footerCount': 'Showing {{count}} of {{total}} templates',
    'settings.notificationTemplates.loading': 'Loading templates...',
    'settings.notificationTemplates.nounPlural': 'templates',
    'settings.notificationTemplates.searchPlaceholder': 'Search templates…',
    'settings.notificationTemplates.subtitle': 'Customize the email and SMS messages sent to customers. Use Mustache variables like',
    'settings.notificationTemplates.summary': 'customized · {{systemDefault}} on system defaults',
    'settings.notificationTemplates.versionShort': 'v{{version}}',
    'settings.notificationTemplates.status.customized': 'Customized',
    'settings.notificationTemplates.status.systemDefault': 'System default',
    'settings.notificationTemplates.table.audience': 'Audience',
    'settings.notificationTemplates.table.channel': 'Channel',
    'settings.notificationTemplates.table.status': 'Status',
    'settings.notificationTemplates.table.subject': 'Subject',
    'settings.notificationTemplates.table.template': 'Template',
    'settings.notificationTemplates.table.version': 'Version',
    'settings.nav.general': 'General',
    'settings.nav.itemStatuses': 'Item Statuses',
    'settings.nav.modulesFeatures': 'Modules & Features',
    ...
    'settings.showingCount': 'Showing {{count}} {{noun}}',
    'settings.soon': 'Soon',
    'settings.terminology.applyPreset': 'Apply preset',
    'settings.terminology.applyPresetConfirmTitle': 'Apply {{name}} preset?',
    'settings.terminology.applyPresetSubline': 'You can switch or adjust any field after.',
    'settings.terminology.default': 'default',
    'settings.terminology.description': 'Customize how entity names appear throughout the app and on customer-facing documents. Leave a field blank to use the default shown in the placeholder.',
    'settings.terminology.dirtyHint': 'Unsaved changes',
    'settings.terminology.footerNote': 'Renaming entities does not affect existing records or their IDs. The new name shows in the UI and on customer-facing documents from the next page load. Custom terminology survives upgrades.',
    'settings.terminology.footerNoteLead': 'Note:',
    'settings.terminology.groupCustomer': 'Customer & Service',
    ...
    'settings.terminology.presetCardSubtitle': 'Apply a preset any time to seed entity names with conventions common to your trade. You can adjust any field after — and switch presets later without losing your other settings.',
    'settings.terminology.presetCardTitle': 'Industry preset',
    'settings.terminology.presetDefines': '{{name}} has its own names for {{entities}}.',
    'settings.terminology.presetKept': 'Your customizations to {{entities}} will be kept.',
    'settings.terminology.presetKeptGeneric': "Names you haven't set here stay on their defaults.",
    'settings.terminology.presetMatchesDefaults': "{{name}} uses the system default names — applying it won't change anything. Use Reset to defaults to clear your customizations.",
    'settings.terminology.presetNothingCustomized': "None of these are customized yet — nothing you'd miss will be overwritten.",
    'settings.terminology.presetReplaceIntro': '{{count}} of those {{total}} are currently customized and will be replaced:',
    'settings.terminology.presetReplaceIntro_one': '{{count}} of those {{total}} is currently customized and will be replaced:',
    'settings.terminology.presetWas': '(currently {{value}})',
    'settings.terminology.resetAllConfirmMessage': 'Clears every custom singular and plural and restores the system defaults. You can undo by closing without saving.',
    'settings.terminology.resetAllConfirmTitle': 'Reset all terminology to defaults?',
    'settings.terminology.resetAllLabel': 'Reset to defaults',
    'settings.terminology.saveChanges': 'Save changes',
    'settings.terminology.saveError': "Couldn't save terminology",
    'settings.terminology.saveSuccess': 'Terminology saved',
    'settings.terminology.title': 'Terminology',
    'settings.terminology.unknownKeysError': 'Unknown entity in saved terminology: {{keys}}. Contact support.',
    ...
    'settings.workflowConfig.behavior': 'Behavior',
    'settings.workflowConfig.boardTypeHelper': 'Choose how the dispatch board groups work.',
    'settings.workflowConfig.defaultItemStatus': 'Default Item Status',
    ...
    'settings.workflowConfig.defaultWorkOrderType': 'Default {{workOrder}} Type',
    'settings.workflowConfig.defaults': 'Defaults',
    'settings.workflowConfig.description': 'Tenant-wide rules that govern how work moves through the system.',
    'settings.workflowConfig.descriptionLong': 'Tenant-wide rules that govern how work moves through the system. Changes here affect every work order — new and existing.',
    'settings.workflowConfig.dispatchBoardType': '{{dispatch}} Board Type',
    'settings.workflowConfig.enforce': 'Enforce Status Workflow',
    'settings.workflowConfig.enforceHelper': 'When enabled, only transitions defined in Status Workflows are allowed.',
    'settings.workflowConfig.errorLoad': 'Failed to load workflow config.',
    'settings.workflowConfig.errorSave': 'Failed to update workflow config',
    'settings.workflowConfig.lastSaved': 'Last saved {{when}}',
    'settings.workflowConfig.noneOption': 'None',
    'settings.workflowConfig.scheduleBased': 'Schedule-based',
    'settings.workflowConfig.statusBased': 'Status-based',
    'settings.workOrderTypes.codeChangedWarning': 'Changing the code may break integrations and reports that reference this type.',
    'settings.workOrderTypes.codeHint': 'Stable identifier. UPPERCASE_WITH_UNDERSCORES. Auto-generated from name.',
    'settings.workOrderTypes.codeImmutable': 'Editing the code may break integrations and reports.',
    'settings.workOrderTypes.colCode': 'Code',
    'settings.workOrderTypes.colColor': 'Color',
    'settings.workOrderTypes.colName': 'Name',
    'settings.workOrderTypes.colorConflict': 'This color is already used by {{typeName}}. Pick a different color.',
    'settings.workOrderTypes.colorHint': 'Shown on {{workOrder, lowercase}} lists, the dispatch board, and reports.',
    'settings.workOrderTypes.colorLabel': 'Color',
    'settings.workOrderTypes.colorTakenBy': 'Used by {{name}}',
    'settings.workOrderTypes.couldNotLoad': "Couldn't load {{workOrder, lowercase}} types",
    'settings.workOrderTypes.deleteConfirm': 'Delete "{{name}}"?',
    'settings.workOrderTypes.deleteWarning': '{{workOrder}}s currently classified as this type will keep their value until reassigned.',
    'settings.workOrderTypes.description': 'Categories that classify {{workOrder}}s.',
    'settings.workOrderTypes.emptyDescription': 'Add a type to start classifying {{workOrder, lowercase}}s.',
    'settings.workOrderTypes.emptyTitle': 'No {{workOrder, lowercase}} types yet',
    'settings.workOrderTypes.errorCreate': 'Failed to create {{workOrder, lowercase}} type',
    'settings.workOrderTypes.errorUpdate': 'Failed to update {{workOrder, lowercase}} type',
    'settings.workOrderTypes.form.create': 'Create type',
    'settings.workOrderTypes.form.save': 'Save changes',
    'settings.workOrderTypes.form.titleAdd': 'Add {{workOrder}} Type',
    'settings.workOrderTypes.form.titleEdit': 'Edit {{name}}',
    'settings.workOrderTypes.noMatches': 'No {{workOrder, lowercase}} types match your search.',
    'settings.workOrderTypes.rowsCount': '{{count}} {{noun}}',
    'settings.workOrderTypes.searchPlaceholder': 'Search types…',
    'settings.workOrderTypes.singular': 'Type',
    'settings.workOrderTypes.subtitle': '{{count}} types · used to classify {{workOrder, lowercase}}s in lists, the dispatch board, and reports',
    ...
    'workOrders.detail.money.balanceShort': 'Bal',
    ...
    'approvals.empty.openMode.title': "Approvals don't fire in Open mode",
    'approvals.empty.openMode.description':
      'Approval requests are only created when workflow enforcement is set to Strict. Open mode allows any status transition without gates.',
    'approvals.empty.openMode.action': 'Configure workflows →',
    'approvals.errors.couldNotLoad': "Couldn't load approvals",
    'approvals.bell.title': 'Approvals',
    'approvals.bell.countPill': '{{count}} pending',
    'approvals.bell.loading': 'Loading…',
    'approvals.bell.notePlaceholder': 'Note to requester (required to reject)…',
    'approvals.bell.preferences': 'Preferences',
    'approvals.bell.recentlyResolved': 'Recently resolved',
    'approvals.bell.requestedApproval': 'requested approval',
    'approvals.bell.statusApproved': 'Approved',
    'approvals.bell.statusExpired': 'Expired',
    'approvals.bell.statusRejected': 'Rejected',
    'approvals.bell.tabs.forMe': 'For me',
    'approvals.bell.tabs.mine': 'Mine',
    'approvals.bell.viewAll': 'View all in queue',
