...
vi.mock('react-i18next', () => {
  const translations = {
    ...
    'settings.equipmentTaxonomy.delete.categoryMessage': 'Equipment records using this category will lose their category assignment.',
    'settings.equipmentTaxonomy.delete.categoryTitle': 'Delete {{name}}?',
    'settings.equipmentTaxonomy.delete.typeMessage': '{{count}} categories will be deleted. Equipment records using this type will lose their type assignment.',
    'settings.equipmentTaxonomy.delete.typeMessageEmpty': 'This type has no categories. Delete?',
    'settings.equipmentTaxonomy.delete.typeMessageOne': '1 category will be deleted. Equipment records using this type will lose their type assignment.',
    ...
    'settings.equipmentTaxonomy.dialog.addType': 'Add equipment type',
    'settings.equipmentTaxonomy.dialog.editCategory': 'Edit category',
    'settings.equipmentTaxonomy.dialog.editType': 'Edit equipment type',
    ...
    'settings.equipmentTaxonomy.empty.noTypesTitle': 'No equipment types yet',
    'settings.equipmentTaxonomy.errorLoad': "Couldn't load equipment types",
    'settings.equipmentTaxonomy.errorSaveCategory': 'Failed to save category',
    'settings.equipmentTaxonomy.errorSaveType': 'Failed to save equipment type',
    'settings.equipmentTaxonomy.expandAll': 'Expand all',
    'settings.equipmentTaxonomy.loading': 'Loading equipment types…',
    'settings.equipmentTaxonomy.searchPlaceholder': 'Search types & categories…',
    'settings.equipmentTaxonomy.subtitle': 'Equipment classifications used when adding equipment records. Drag to reorder — order shown is the order in dropdowns.',
