...
vi.mock('react-i18next', () => {
  const translations = {
    ...
    'settings.workOrderTypes.colorHint': 'Shown on work order lists, the dispatch board, and reports.',
    'settings.workOrderTypes.colorLabel': 'Color',
    'settings.workOrderTypes.colorTakenBy': 'Used by {{name}}',
    'settings.workOrderTypes.couldNotLoad': "Couldn't load work order types",
    'settings.workOrderTypes.deleteConfirm': 'Delete "{{name}}"?',
    'settings.workOrderTypes.deleteWarning': 'Work orders currently classified as this type will keep their value until reassigned.',
    'settings.workOrderTypes.description': 'Categories that classify {{workOrder}}s.',
    'settings.workOrderTypes.emptyDescription': 'Add a type to start classifying work orders.',
    'settings.workOrderTypes.emptyTitle': 'No work order types yet',
    'settings.workOrderTypes.errorCreate': 'Failed to create work order type',
    'settings.workOrderTypes.errorUpdate': 'Failed to update work order type',
    'settings.workOrderTypes.form.create': 'Create type',
    'settings.workOrderTypes.form.save': 'Save changes',
    'settings.workOrderTypes.form.titleAdd': 'Add Work Order Type',
    'settings.workOrderTypes.form.titleEdit': 'Edit {{name}}',
    'settings.workOrderTypes.noMatches': 'No work order types match your search.',
    ...
    'settings.workOrderTypes.subtitle': '{{count}} types · used to classify work orders in lists, the dispatch board, and reports',
