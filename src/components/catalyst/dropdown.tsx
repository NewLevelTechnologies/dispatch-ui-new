...
export function DropdownItem({
  ...
  const classes = clsx(
    ...
    '*:data-[slot=icon]:text-fg-muted data-focus:*:data-[slot=icon]:text-white',
    // Avatar
...
export function DropdownHeading({
  ...
  return (
    <Headless.MenuHeading
      ...
      className={clsx(
        className,
        'col-span-full grid grid-cols-[1fr_auto] gap-x-12 px-3.5 pt-2 pb-1 text-sm/5 font-medium text-fg-muted sm:px-3 sm:text-xs/5'
      )}
    />
  )
}
...
export function DropdownDivider({
  ...
  return (
    <Headless.MenuSeparator
      ...
      className={clsx(
        className,
        'col-span-full mx-3.5 my-1 h-px border-0 bg-border-soft sm:mx-3 forced-colors:bg-[CanvasText]'
      )}
    />
  )
}
...
export function DropdownDescription({
  ...
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        'col-span-2 col-start-2 row-start-2 text-sm/5 text-fg-muted group-data-focus:text-white sm:text-xs/5 forced-colors:group-data-focus:text-[HighlightText]'
      )}
    />
  )
}
    ...
    >
      {(Array.isArray(keys) ? keys : keys.split('')).map((char, index) => (
        <kbd
          key={index}
          className={clsx([
            'min-w-[2ch] text-center font-sans text-fg-dim capitalize group-data-focus:text-white forced-colors:group-data-focus:text-[HighlightText]',
